...
namespace Student
{
    ...
    private:
        ...
        std::vector<std::vector<ChessPiece *>> prevBoard;
    ...
    public:
        ...
        void updateEnPassant(bool val) {enPassant = val;}
        ...
        // ChessBoard getprevBoard(return prevBoard;);
        /**
         * @return
        ...
        ChessPiece *getPrevPiece(int r, int c) {return prevBoard.at(r).at(c);}
        ...
        ChessPiece * tempMovePiece(int fromRow, int fromColumn, int toRow, int toColumn);

        void revertTempMove(ChessPiece * piece, int oldRow, int oldColumn, int toRow, int toCol); //moves the pieces back to og positions

        bool isSquareUnderThreat(Color color, int row, int col);
        ...
        ChessPiece *getKing(Color col); //gives you piece that is the king

        void isValidScan(int n, int m);
        void underThreatScan(int n, int m);
    };
}
