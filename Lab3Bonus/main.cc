...
void h2() {
    Student::ChessBoard sBoard(5,5);
    sBoard.createChessPiece(White, Pawn, 3, 0);
    //std::cout << sBoard.displayBoard().str() << "\n";
    //sBoard.movePiece(2, 0, 0, 0);
    std::cout << sBoard.displayBoard().str() << "\n";
    sBoard.isValidScan(5,5);
    // std::cout << sBoard.isValidMove(0,0, 2, 1) << "\n";
    // sBoard.createChessPiece(Black, Pawn, 1, 3);
    // sBoard.movePiece(1,3,3,3);
    // std::cout << sBoard.displayBoard().str() << "\n";
    sBoard.createChessPiece(Black, Knight, 2, 2);
    sBoard.isValidScan(5,5);
    ...
    // std::cout << sBoard.displayBoard().str() << "\n";
    //std::cout << sBoard.isValidMove(1,2, 0, 0) << "\n";
...
void h3() {
    ...
    sBoard.isValidScan(8,8);
    std::cout << sBoard.displayBoard().str() << "\n";
    std::cout << sBoard.scoreBoard() << "\n";
    std::cout << sBoard.getHighestNextScore() << "\n";
}
